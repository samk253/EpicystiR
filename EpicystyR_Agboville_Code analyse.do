...
log using "/Users/.../Epicysti R_Agboville.log"

************************************************************
*****Epidémiologie de la cysticercose en milieu rural: *****
*****     cas du département d'Agboville.              *****
************************************************************

*Ouvrir le fichier de données
use "/Users/.../Epicysti R_Agboville.dta"
...
/*Après avoir déclaré le plan de sondage: le niveau 1 étant considere comme un TAS avec remise, le niveau 2 a été ignoré dans le design*/
...
svy linearized : tabulate village, cell ci obs percent
svy linearized : mean age

*Tableaux croisés de la sérologie avec les variables indépendantes (analyses bivariées : y = cysti)
...
svy linearized : tabulate zone cysti, row obs column percent pearson lr wald
svy : logistic cysti i.zone

*Données de séroprévalence de la cysticercose par village pour la réalisation de la carte
svy linearized : tabulate vilagag cysti, row obs column percent pearson lr wald
svy : logistic cysti i.vilagag
...
svy : logistic cysti i.age_cat sexe instruit muslim depara i.lavcrudi
svy : logistic cysti i.age_cat instruit muslim depara i.lavcrudi
svy : logistic cysti i.age_cat instruit muslim i.lavcrudi
